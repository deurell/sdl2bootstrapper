...
struct Matrix4 {
    ...
    static Matrix4<T> Frustum(T left, T right, T bottom, T top, T nearPlane, T farPlane) {
        T a = 2 * nearPlane / (right - left);
        T b = 2 * nearPlane / (top - bottom);
        T c = (right + left) / (right - left);
        T d = (top + bottom) / (top - bottom);
        T e = - (farPlane + nearPlane) / (farPlane - nearPlane);
        T f = -2 * farPlane * nearPlane / (farPlane - nearPlane);
        Matrix4 m;
